...
public class assessment_1 {
 ...
 @Test(priority = 1)
  public void login() {
	  driver.findElement(By.id(locator.usernameTextbox)).clear();
	  driver.findElement(By.id(locator.usernameTextbox)).sendKeys(Inputvalues.UserNameLogin);
	  driver.findElement(By.id(locator.passwordTextbox)).clear();
	  driver.findElement(By.id(locator.passwordTextbox)).sendKeys(Inputvalues.Password);
	  
	  driver.findElement(By.id(locator.LoginButton)).click();
		...
		if(driver.findElement(By.id("btnAdd")) != null) {
			...
			if(driver.getCurrentUrl().contains("saveSystemUser") && driver.findElement(By.id("UserHeading")).getText().equalsIgnoreCase("Add User")) {
				...
				if (Statuslocation.getFirstSelectedOption().getText().equalsIgnoreCase("Enabled")) {
					...
					driver.findElement(By.id("systemUser_employeeName_empName")).sendKeys(Inputvalues.EmployeeName);
					...
					driver.findElement(By.id("systemUser_password")).sendKeys(Inputvalues.Pass1);
					
					driver.findElement(By.id("systemUser_confirmPassword")).clear();
					driver.findElement(By.id("systemUser_confirmPassword")).sendKeys(Inputvalues.Pass1);
